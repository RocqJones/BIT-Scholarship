...
-- should only provide the results if the standard order quantity exceeds 100 and the
-- poster order quantity exceeds 50. Your final table should have 3 columns: region name,
