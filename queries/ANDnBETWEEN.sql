...
-- Figure out the answer to this important question by writing a query that displays the
...
--  The answer to the question is that yes, the BETWEEN operator in SQL is inclusive; that is,
-- the endpoint values are included.
